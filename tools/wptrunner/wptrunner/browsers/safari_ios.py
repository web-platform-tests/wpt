...
__wptrunner__ = {"product": "safari_ios",
                 "check_args": "check_args",
                 "browser": "SafariiOSBrowser",
...
def executor_kwargs(test_type, server_config, cache_manager, run_info_data,
    ...
    if kwargs["binary"] is not None:
        raise ValueError("Safari iOS doesn't support setting executable location")
...
class SafariiOSBrowser(Browser):
    """Safari iOS is backed by safaridriver, which is supplied through
