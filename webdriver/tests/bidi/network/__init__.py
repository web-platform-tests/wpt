...
PAGE_SCRIPT_IMPORTS_OTHER = "/webdriver/tests/bidi/network/support/imports-other.mjs"
PAGE_CSS_IMPORTS_OTHER = "/webdriver/tests/bidi/network/support/imports-other.css"
PAGE_SCRIPT_FETCH = "/webdriver/tests/bidi/network/support/fetch.mjs"
