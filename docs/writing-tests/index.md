...
interpreted. You might already have an idea about what still needs testing, but
it's okay if you don't know where to begin. In either case, [this guide on
making a testing plan](making-a-testing-plan) will help you decide what to
write.
