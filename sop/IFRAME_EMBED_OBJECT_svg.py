...
tests = [
        ("HD_A_iframe_ED_A_r", "success"),
        ("HD_A_iframe_ED_A_w", "success"),
        ("HD_A_iframe_ED_A_x", ""),
        ...
        ("ED_A_iframe_HD_A_r", ""),
        ("ED_A_iframe_HD_A_w", ""),
        ("HD_A_iframe_ED_B_r", "fail"),
        ("HD_A_iframe_ED_B_w", "fail"),
        ("HD_A_iframe_ED_B_x", ""),
...
def main(request, response):
    ...
    ee.width = 0;
    ee.height = 0;
    ee.{} = "{}/sop/resources/svg_script.py?operation={}&description={}";
