    ...
    .then(function(results) {
        ...
        Object.keys(sizes).forEach(function(namedCurve) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: publicKeys[namedCurve]}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: {message: "Not a CryptoKey"}}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
                    assert_unreached("deriveKey succeeded but should have failed with TypeError");
                }, function(err) {
            ...
            promise_test(function(test) {
                ...
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: publicKey}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: ecdsaKeyPairs[namedCurve].publicKey}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
                    assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                }, function(err) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: publicKeys[namedCurve]}, noDeriveKeyKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
                    assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                }, function(err) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: publicKeys[namedCurve]}, publicKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
                    assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                }, function(err) {
            ...
            promise_test(function(test) {
                return subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: privateKeys[namedCurve]}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                .then(function(exportedKey) {
                    assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                }, function(err) {
            ...
            promise_test(function(test) {
                ...
                .then(function(secretKey) {
                    subtle.deriveKey({name: "ECDH", namedCurve: namedCurve, public: secretKey}, privateKeys[namedCurve], {name: "AES-CBC", length: 128}, true, ["encrypt", "decrypt"])
                    .then(function(key) {return crypto.subtle.exportKey("raw", key);})
                    .then(function(exportedKey) {
                        assert_unreached("deriveKey succeeded but should have failed with InvalidAccessError");
                    }, function(err) {
