...
class SelectorProtocolPart(ProtocolPart):
    ...
    def element_by_selector(self, element_selector, frame_selector="window"):
        elements = self.elements_by_selector(element_selector, frame_selector)
        if len(elements) == 0:
    ...
    @abstractmethod
    def elements_by_selector(self, element_selector, frame_selector="window"):
