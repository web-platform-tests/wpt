// META: title=Testing if modifying local storage invalidation signals can evict a BFCache entry expectedly.
...
promise_test(async t => {
  ...
  await rc1.executeScript(() => {
    window.inactiveDocumentController.invalidationSignals.setLocalStorage(
      ['a']
    );
  });
