...
def get_tree(tests_root: str, manifest: Manifest, manifest_path: str | None, cache_root: str | None,
...
class GitHasher:
    ...
    def hash_cache(self) -> dict[str, str | None]:
        """
...
class FileSystem:
    ...
    def __iter__(self) -> Iterator[tuple[str, str | None, bool]]:
