import { createTestSubject } from "./create-test-subject.js";
...
test(() => {
  ...
  assert_true(
    flattened instanceof Observable,
...
test(() => {
  ...
  assert_array_equals(
    results,
    [10, 100, "active", 20, 200, error, "inactive"],
