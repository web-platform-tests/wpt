...
<h1><a href="http://www.w3.org/TR/dom">DOM4</a> Tests</h1>
<p style="color:#CC0000">Only document.contentType is currently addressed by these tests from the DOM4 specification.</p>
<iframe></iframe>
<!--<form>
...
function getDirectory( $path = '.' ){
  ...
  $ignore = array( 'non-automated', 'Watir', 'resources', 'support', 'invalid', 'bugs', 'reftest' );
