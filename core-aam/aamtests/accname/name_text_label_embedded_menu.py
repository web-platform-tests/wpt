TEST_HTML = "<input type='text' id='test' /> <label for='test'>Flash the screen <span role='menu'> <span role='menuitem' aria-selected='true'>1</span> <span role='menuitem' hidden>2</span> <span role='menuitem' hidden>3</span> </span> times. </label>"
