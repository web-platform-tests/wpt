...
function testAnimValInitialize()
{
	...
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.initialize(t)}, "animVal.initialize() should throw NO_MODIFICATION_ALLOWED_ERR"); 
}

function testAnimValClear()
{
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.clear()}, "animVal.clear() should throw NO_MODIFICATION_ALLOWED_ERR"); 
}

function testAnimValInsertItemBefore()
{
	var t = document.getElementById("svg").createSVGTransform();
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.insertItemBefore(t, 0)}, "animVal.insertItemBefore should throw NO_MODIFICATION_ALLOWED_ERR");
}

function testAnimValReplaceItem()
{
	var t = document.getElementById("svg").createSVGTransform();
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.replaceItem(t, 0)}, "animVal.replaceItem should throw NO_MODIFICATION_ALLOWED_ERR");
}

function testAnimValAppendItem()
{
	var t = document.getElementById("svg").createSVGTransform();
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.appendItem(t)}, "animVal.appendItem should throw NO_MODIFICATION_ALLOWED_ERR");
}

function testAnimValRemoveItem()
{
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.removeItem(0)}, "animVal.removeItem should throw NO_MODIFICATION_ALLOWED_ERR");
}
...
{
	assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.consolidate()}, "animVal.consolidate should throw NO_MODIFICATION_ALLOWED_ERR");
}
...
function testAnimValSetMatrix() {
	...
	for(var i = 0; i < tList.animVal.numberOfItems; i++)
	{
		assert_throws({name: 'NO_MODIFICATION_ALLOWED_ERR'}, function(){tList.animVal.getItem(i).setMatrix(m)}, "transform.setMatrix on animVal should throw NO_MODIFICATION_ALLOWED_ERR");
	}
}
...
function testBaseValClear()
{
	...
	assert_throws(null, function(){tList.baseVal.getItem(0)}, "baseVal.getItem() on an empty list should throw an error");
}

function testBaseValInitializeInvalid()
{
	assert_throws(null, function(){tList.baseVal.initialize(null)}, "baseVal.initialize(null) should throw an error");
	assert_throws(null, function(){tList.baseVal.initialize(30)}, "baseVal.initialize(30) should throw an error");
	assert_throws(null, function(){tList.baseVal.initialize("someString")}, "initialize('someString') should throw an error");
	assert_throws(null, function(){tList.baseVal.initialize(new Object())}, "initialize(new Object()) should throw an error");
}

function testBaseValGetItemInvalid()
{
	assert_throws(null, function(){tList.baseVal.getItem(30)}, "baseVal.getItem(30) should throw an error");
...
function testBaseValInsertItemBeforeInvalid()
{
	...
	assert_throws(null, function(){tList.baseVal.insertItemBefore(null, 0)}, "baseVal.insertItemBefore(null, 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.insertItemBefore("someString", 0)}, "baseVal.insertItemBefore('someString', 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.insertItemBefore(new Object(), 0)}, "baseVal.insertItemBefore(new Object(), 0) should throw an error");
	
	// Should an error be thrown if arg2 is invalid? Nothing in spec and no error is thrown so these currently fail as they are. 
	/*
	assert_throws(null, function(){tList.baseVal.insertItemBefore(t, null)}, "baseVal.insertItemBefore(t, null) should throw an error");
	assert_throws(null, function(){tList.baseVal.insertItemBefore(t, "someString")}, "baseVal.insertItemBefore(t, 'someString') should throw an error");
	assert_throws(null, function(){tList.baseVal.insertItemBefore(t, new Object())}, "baseVal.insertItemBefore(t, new Object()) should throw an error");
	*/
}

function testBaseValReplaceItemInvalid()
{
	assert_throws(null, function(){tList.baseVal.replaceItem(null, 0)}, "baseVal.replaceItem(null, 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.replaceItem("someString", 0)}, "baseVal.replaceItem('someString', 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.replaceItem(new Object(), 0)}, "baseVal.replaceItem(new Object(), 0) should throw an error");
	
	// Should an error be thrown if arg2 is invalid? Nothing in spec and no error is thrown so these currently fail as they are. 
	/*
	var t = document.getElementById("svg").createSVGTransform();
	assert_throws(null, function(){tList.baseVal.replaceItem(t, null)}, "baseVal.replaceItem(t, null) should throw an error");
	assert_throws(null, function(){tList.baseVal.replaceItem(t, "someString")}, "baseVal.replaceItem(t, 'someString') should throw an error");
	assert_throws(null, function(){tList.baseVal.replaceItem(t, new Object())}, "baseVal.replaceItem(t, new Object()) should throw an error");
	*/
}

function testBaseValAppendItemInvalid()
{
	assert_throws(null, function(){tList.baseVal.appendItem(null, 0)}, "baseVal.appendItem(null, 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.appendItem("someString", 0)}, "baseVal.appendItem('someString', 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.appendItem(new Object(), 0)}, "baseVal.appendItem(new Object(), 0) should throw an error");
	
	// Should an error be thrown if arg2 is invalid? Nothing in spec and no error is thrown so these currently fail as they are. 
	/*
	var t = document.getElementById("svg").createSVGTransform();
	assert_throws(null, function(){tList.baseVal.appendItem(t, null)}, "baseVal.appendItem(t, null) should throw an error");
	assert_throws(null, function(){tList.baseVal.appendItem(t, "someString")}, "baseVal.appendItem(t, 'someString') should throw an error");
	assert_throws(null, function(){tList.baseVal.appendItem(t, new Object())}, "baseVal.appendItem(t, new Object()) should throw an error");
	*/
}

function testBaseValRemoveItemInvalid()
{
	assert_throws(null, function(){tList.baseVal.removeItem(10)}, "baseVal.removeItem() should throw an error on invalid index");
	assert_throws(null, function(){tList.baseVal.removeItem(-1)}, "baseVal.removeItem() should throw an error on invalid index");
	...
	/*
	assert_throws(null, function(){tList.baseVal.removeItem(null)}, "baseVal.removeItem() should throw an error on invalid index");
	assert_throws(null, function(){tList.baseVal.removeItem("someString")}, "baseVal.removeItem() should throw an error on invalid index");
	assert_throws(null, function(){tList.baseVal.removeItem(new Object())}, "baseVal.removeItem() should throw an error on invalid index");
	*/
}

function testBaseValCreateSVGTransformFromMatrixInvalid()
{
	assert_throws(null, function(){tList.baseVal.createSVGTransformFromMatrix(null)}, "baseVal.createSVGTransformFromMatrix(null) should throw an error");
	assert_throws(null, function(){tList.baseVal.createSVGTransformFromMatrix("someString")}, "baseVal.createSVGTransformFromMatrix('someString', 0) should throw an error");
	assert_throws(null, function(){tList.baseVal.createSVGTransformFromMatrix(new Object())}, "baseVal.createSVGTransformFromMatrix(new Object(), 0) should throw an error");
}
