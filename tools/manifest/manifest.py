...
class Manifest:
    ...
    def update(self, tree: Iterable[Tuple[str, Optional[str], bool]], parallel: bool = True) -> bool:
        ...
        if parallel and len(to_update) > 25 and cpu_count() > 1:
            ...
            results: Iterator[Tuple[Tuple[str, ...], str, Set[ManifestItem], str]] = \
                pool.imap_unordered(compute_manifest_items, to_update, chunksize=chunksize)
        else:
    ...
    @classmethod
    def from_json(cls, tests_root: str, obj: Dict[str, Any], types: Optional[Container[str]] = None,
