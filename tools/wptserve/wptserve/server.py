...
class BaseWebTestRequestHandler(socketserver.StreamRequestHandler):
...
class Http1WebTestRequestHandler(BaseWebTestRequestHandler, http.server.BaseHTTPRequestHandler):
