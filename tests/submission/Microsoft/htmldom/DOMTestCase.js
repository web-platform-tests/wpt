...
{
   if ( document.mimeType == "HTML Document" )
   {
       return "text/html";
   }
}
//
//  These all throw upon assertion failures
//

function assertTrue(description, state)
{
    var szError = "assertTrue failure\r\n";
...
function assertFalse(description, state)
{
    var szError = "assertFalse failure\r\n";
...
{
    var szError = "assertNull failure: non-null parameter\r\n";

    if (description == null || actual != null)
    {
        throw szError;
    }
}
...
{
    var szError = "assertNotNull failure: null parameter\r\n";
...
function load(documentRefrence)
{
    return documentRefrence.document;
}
