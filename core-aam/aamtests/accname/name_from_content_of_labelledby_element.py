TEST_HTML = "<style> .hidden { display: none; } </style> <input id='test' type='text' aria-labelledby='lblId' /> <div id='lblId'> <span aria-hidden='true'><i> Hello, </i></span> <span>My</span> name is <div><img src='file.jpg' title='Bryan' alt='' role='presentation' /></div> <span role='presentation' aria-label='Eli'> <span aria-label='Garaventa'>Zambino</span> </span> <span>the weird.</span> (QED) <span class='hidden'><i><b>and don't you forget it.</b></i></span> <table> <tr> <td>Where</td> <td style='visibility:hidden;'><div>in</div></td> <td><div style='display:none;'>the world</div></td> <td>are my marbles?</td> </tr> </table> </div>"
