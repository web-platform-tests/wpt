...
pressure_test(async (t, mockPressureService) => {
  ...
  assert_greater_than_equal(
      observer1Changes[1][0].time - observer1Changes[0][0].time,
      (1 / sampleRate * 1000));
  assert_greater_than_equal(
      observer1Changes[2][0].time - observer1Changes[1][0].time,
      (1 / sampleRate * 1000));
  assert_greater_than_equal(
      observer2Changes[1][0].time - observer2Changes[0][0].time,
      (1 / doubleSampleRate * 1000));
  assert_greater_than_equal(
      observer2Changes[2][0].time - observer2Changes[1][0].time,
      (1 / doubleSampleRate * 1000));
