...
products, you may need to install the extra dependencies. If required, these
are provided as requirements_[name].txt in the %s directory and can be installed
using e.g.""" % path, 80)
