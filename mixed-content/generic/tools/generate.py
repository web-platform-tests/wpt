...
class MixedContentConfig(object):
    def __init__(self):
        ...
        self.test_description_template = 'The mixed content should be %(expectation)s for %(subresource)s to %(origin)s origin and %(redirection)s redirection from %(source_scheme)s context.'
