...
class ReferrerPolicyConfig(object):
    def __init__(self):
        ...
        self.test_description_template = 'The referrer URL is %(expected)s for %(subresource)s to %(origin)s origin and %(redirection)s redirection from %(source_protocol)s context.'
