...
// Whether to work around old API (createShadowRoot).
var USE_OLD_API_WORKAROUND = true;

function activateOldAPIWorkaround() {
...
if (USE_OLD_API_WORKAROUND)
    activateOldAPIWorkaround();
