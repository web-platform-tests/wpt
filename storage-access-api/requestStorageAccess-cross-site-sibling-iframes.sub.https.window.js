...
(async function() {
  ...
  promise_test(async (t) => {
    ...
    assert_false(await HasUnpartitionedCookie(frame1), "frame1 should not have access via document.cookie.");
    assert_false(await HasUnpartitionedCookie(frame2), "frame2 should not have access via document.cookie.");
    ...
    assert_true(await HasUnpartitionedCookie(frame1), "frame1 should now be able to write cookies via document.cookie.");

    assert_false(await FrameHasStorageAccess(frame2), "frame2 should still not have storage access.");
    assert_false(await HasUnpartitionedCookie(frame2), "frame2 should still be unable to write cookies via document.cookie");
    ...
    assert_true(await HasUnpartitionedCookie(frame2), "frame2 should be able to write cookies via document.cookie after getting storage access.");
