...
const tests = [
    ...
    {
        name: '[gru] DataError is expected if steps equals to zero',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
    ...
    {
        name: '[gru] DataError is expected if hiddenSize equals to zero',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name: '[gru] DataError is expected if hiddenSize is too large',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the data type of the inputs is not one of the floating point types',
    ...
    {
        name:
            '[gru] DataError is expected if the size of input.dimensions is not 3',
    ...
    {
        name:
            '[gru] DataError is expected if the size of input.dimensions[0] does not equal to steps',
    ...
    {
        name: '[gru] DataError is expected if the shape of weight is incorrect',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 4 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the size of recurrentWeight.dimensions is not 3',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the size of options.activations is not 2',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the size of options.bias.dimensions is not 2',
        input: { dataType: 'float32', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float32',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
    ...
    {
        name:
            '[gru] DataError is expected if the shape of options.recurrentBias.dimensions is incorrect',
    ...
    {
        name:
            '[gru] DataError is expected if the dataType of options.initialHiddenState is incorrect',
        input: { dataType: 'float16', dimensions: [steps, batchSize, inputSize] },
        weight: {
            dataType: 'float16',
            dimensions: [numDirections, 3 * hiddenSize, inputSize]
