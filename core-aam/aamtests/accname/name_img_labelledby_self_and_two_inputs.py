TEST_HTML = "<input type='text' value='peanuts' id='ID1'> <input type='text' value='popcorn' id='ID2'> <img id='test' aria-label='label' aria-labelledby='test ID1 ID2' src='foo.jpg'/>"
NAME = "label peanuts popcorn"
