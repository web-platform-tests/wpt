...
var A_07_02_04 = {
    ...
    assert:'User Interaction: ' +
        ...
        'inserted into the document navigation order immediately after the shadow host, ' +
        'if the shadow host is focusable;',
    ...
    highlight: '[[For sequential focus navigation, the shadow DOM navigation order sequence must be ' +
    	'inserted into the document navigation order]][\\s\\S]*[[immediately after the shadow host, ' +
    	'if the shadow host is focusable;]]'
};


var A_07_02_04_T01 = async_test('A_07_02_04_T01', PROPS(A_07_02_04, {
...
var A_07_02_04_T02 = async_test('A_07_02_04_T02', PROPS(A_07_02_04, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
...
var A_07_02_04_T03 = async_test('A_07_02_04_T03', PROPS(A_07_02_04, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
...
var A_07_02_04_T04 = async_test('A_07_02_04_T04', PROPS(A_07_02_04, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
