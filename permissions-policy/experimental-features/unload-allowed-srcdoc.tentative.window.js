// META: title='unload' Policy : allowed in srcdoc when allowed in main frame.
...
promise_test(async t => {
  ...
  const subframe =
    await main.addIframeSrcdoc(/*extraConfig=*/{}, /*attributes=*/{ allow: "unload" });
