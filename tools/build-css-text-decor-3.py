#!/usr/bin/python
# CSS Text Decoration Level 3 Test Suite Build Script
...
# Set up
suite = TestSuite('css-text-decor-3_dev', 'CSS Text Decoration Module Level 3 Test Suite', 'http://www.w3.org/TR/css-text-decor-3/')
