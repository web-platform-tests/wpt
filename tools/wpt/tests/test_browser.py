...
def test_edgechromium_webdriver_version(mocked_call):
    ...
    # Working cases.
    mocked_call.return_value = 'EdgeDriver 84.0.4147.30'
    assert edge.webdriver_version(webdriver_binary) == '84.0.4147.30'
    mocked_call.return_value = 'EdgeDriver 87.0.1 (abcd1234-refs/branch-heads/4147@{#310})'
    ...
    mocked_call.return_value = 'EdgeDriver New 84.0.4147.30'
    assert edge.webdriver_version(webdriver_binary) is None
