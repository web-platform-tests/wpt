...
def is_ready(tab: Atspi.Accessible, product: str, url: str) -> bool:
    ...
    if "URI" in document_attributes:
        print(f"Match?: {document_attributes["URI"] == url}")
...
class AtspiWrapper:
    ...
    def get_relations_dictionary_helper(self, node: Accessible) -> Dict[str, List[str]]:
        """
    ...
    def get_state_list_helper(self, node: Accessible) -> List[str]:
        """
