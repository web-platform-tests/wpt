...
class GetElementAttributeTest(base_test.WebDriverBaseTest):
    ...
    def test_none_if_boolean_attribute_absent(self):
        ...
        el = self.driver.find_element_by_tag_name("input")
        self.assertEqual(None, el.get_attribute("checked"))
    ...
    def test_a_href_attribute(self):
        ...
        self.assertEqual("http://example.com/path#fragment", el.get_attribute("href"))
    ...
    def test_attribute_not_present(self):
        ...
        el = self.driver.find_element_by_tag_name("div")
        self.assertEqual(None, el.get_attribute("class"))
