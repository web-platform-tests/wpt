...
@pytest.mark.parametrize("event_path,is_pr,files_changed,expected", [
    ...
    ("epochs_daily_push_event.json", False, None,
     ['download-firefox-beta',
      ...
      'wpt-firefox-beta-test262-9',
      'wpt-firefox-beta-test262-10',
      'wpt-firefox-beta-test262-11',
      'wpt-firefox-beta-test262-12',
      'wpt-firefox-beta-test262-13',
      'wpt-firefox-beta-test262-14',
      'wpt-firefox-beta-test262-15',
      'wpt-firefox-beta-test262-16',
