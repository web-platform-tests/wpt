...
def poll_for_tab(url: str, root: IAccessible2Ptr) -> IAccessible2Ptr:
...
def find_ia2_node(root: IAccessible2Ptr, id: str) -> Optional[IAccessible2Ptr]:
...
def serialize_node(node: IAccessible2Ptr) -> Dict[str, Any]:
