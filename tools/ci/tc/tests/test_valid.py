...
@pytest.mark.parametrize("event_path,is_pr,files_changed,expected", [
    ...
    ("epochs_daily_push_event.json", False, None,
     {'download-firefox-stable',
      ...
      'wpt-py3-chrome-dev-reftest-1',
      'wpt-py3-chrome-dev-reftest-2',
      'wpt-py3-chrome-dev-reftest-3',
      'wpt-py3-chrome-dev-reftest-4',
      'wpt-py3-chrome-dev-reftest-5',
      'wpt-py3-chrome-dev-testharness-1',
      'wpt-py3-chrome-dev-testharness-10',
      'wpt-py3-chrome-dev-testharness-11',
      'wpt-py3-chrome-dev-testharness-12',
      'wpt-py3-chrome-dev-testharness-13',
      'wpt-py3-chrome-dev-testharness-14',
      'wpt-py3-chrome-dev-testharness-15',
      'wpt-py3-chrome-dev-testharness-16',
      'wpt-py3-chrome-dev-testharness-2',
      'wpt-py3-chrome-dev-testharness-3',
      'wpt-py3-chrome-dev-testharness-4',
      'wpt-py3-chrome-dev-testharness-5',
      'wpt-py3-chrome-dev-testharness-6',
      'wpt-py3-chrome-dev-testharness-7',
      'wpt-py3-chrome-dev-testharness-8',
      'wpt-py3-chrome-dev-testharness-9',
      'wpt-py3-chrome-dev-wdspec-1',
      'wpt-py3-chrome-dev-crashtest-1',
