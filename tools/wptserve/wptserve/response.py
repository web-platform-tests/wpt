...
class H2ResponseWriter(object):
    ...
    def write_raw_header_frame(self, headers, stream_id=None, end_stream=False, end_headers=False):
        ...
        with self.h2conn as connection:
            frame = HeadersFrame(stream_id, data=connection.encoder.encode(header_t))
