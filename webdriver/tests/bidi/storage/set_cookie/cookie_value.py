...
async def test_cookie_value_string(bidi_session, top_context, test_page, origin, domain_value, str_value):
    ...
    await assert_cookie_is_set(bidi_session, value=value, domain=domain_value(), origin=origin())
