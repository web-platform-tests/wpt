...
from third_party.hyper.common.connection import HTTPConnection
from third_party.hyper.compat import urlparse
from third_party.hyper.tls import init_context
