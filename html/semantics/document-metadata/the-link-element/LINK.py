...
def main(request, response):
    ...
    for (testname, expected) in tests:
        ...
        wrapper.width = 0;
        wrapper.height = 0;
        wrapper.src = '{}/html/semantics/document-metadata/the-link-element/resources/css_wrapper.py?from={}&to={}&origin={}&crossorigin={}&credentials={}&operation={} {}&description=LINK - {} to {} - {} - CO: {}, O: {}, UC: {} - {}';
