...
promise_test(async t => {
  ...
  assert_equals(logs.length, 3, 'Browser must follow same-site redirect and fetch manifest');
  ...
  assert_equals(logs[1].endpoint, 'payment-method-identifier', 'Second request must hit redirected PMI URL on same-site subdomain');
