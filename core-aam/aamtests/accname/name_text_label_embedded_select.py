TEST_HTML = "<input type='text' id='test' /> <label for='test'>Flash the screen <select size='1'> <option selected='selected'>1</option> <option>2</option> <option>3</option> </select> times. </label>"
