...
var A_10_05_03 = {
    ...
    assert:'The shadow HTML element: ' +
    	'reset-style-inheritance attribute',
    link:'https://dvcs.w3.org/hg/webcomponents/raw-file/tip/spec/shadow/index.html#shadow-element',
    highlight: '[[reset-style-inheritance, a boolean attribute]]' +
    	'[\\s\\S]*[[indicates the state of the reset-style-inheritance flag for this ' +
    	'shadow insertion point. If present, the value of the flag must be set to true.]]'
};
...
}), 'A_10_05_03_T01', PROPS(A_10_05_03, {
...
}), 'A_10_05_03_T02', PROPS(A_10_05_03, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
