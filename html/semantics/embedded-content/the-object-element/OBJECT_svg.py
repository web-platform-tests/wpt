...
tests = [
        ("HD_A_object_ED_A_r", "success"),
        ("HD_A_object_ED_A_w", "success"),
        ("HD_A_object_ED_B_r", "fail"),
        ("HD_A_object_ED_B_w", "fail"),
        ]
...
<html>
<head>
    <title>OBJECT with SVG test cases</title>
...
def main(request, response):
    ...
    ee.width = 0;
    ee.height = 0;
    ee.data = "{}/html/semantics/embedded-content/resources/svg_script.py?operation={}&description={}";
    ...
    ee.data = "{}/html/semantics/embedded-content/resources/svg.py";
    document.body.appendChild(ee);
    }}""".format(
                settings["ee"],
                testname,
