...
def test_test262_window_test_handler_get_metadata_includes(test262_handlers: Any) -> None:
    ...
    assert ('script', '/test262/harness/assert.js') in metadata
    assert ('script', '/test262/harness/sta.js') in metadata
...
def test_test262_window_test_handler_wrapper_content(test262_handlers: Any) -> None:
    ...
    assert "<script src=\"/test262/harness/assert.js\"></script>" in content
    assert "<script src=\"/test262/harness/sta.js\"></script>" in content
