...
class MetadataModel(BaseModel):
    links: list[LabelLinkModel | UrlLinkModel]
...
def get_labelled_tests(metadata_map: Mapping[str, MetadataModel], label_patterns: Sequence[str | re.Pattern[Any]]) -> Mapping[str, set[str]]:
    rv: dict[str, set[str]] = {}
    for id_prefix, metadata in metadata_map.items():
        for link in metadata.links:
