...
class ActionSequenceAction(object):
    ...
    def __call__(self, payload):
        ...
        self.logger.debug("ActionSequenceAction " )
        self.logger.info("ActionSequenceAction " )
    ...
    def get_element(self, element_selector, frame_selector):
        self.logger.debug("get_element ActionSequenceAction " )
        element = self.protocol.select.element_by_selector(element_selector, frame_selector)
        return element
