browser.test.addTest(function browserRuntimeGetURLErrorCases() {
...
browser.test.addTest(function browserRuntimeGetURLNormalCases() {
...
browser.test.addTest(async function browserRuntimeGetPlatformInfo() {
