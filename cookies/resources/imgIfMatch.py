...
def main(request, response):
    ...
    cookiesWithMatchingNames = request.cookies.get_list(isomorphic_encode(name))
    for cookie in cookiesWithMatchingNames:
        if cookie.value == isomorphic_encode(value):
            ...
            return headers, gif
    return 500, headers, u'{"error": {"message": "The cookie\'s value did not match the given value."}}'
