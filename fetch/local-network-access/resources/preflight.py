...
#     should be sufficient for non-LNA preflight requests to succeed, but not
#     for LNA-specific preflight requests.
#   - cors+pna: this endpoint responds with valid CORS and LNA headers to
#     preflights. These should be sufficient for both non-LNA preflight
#     requests and LNA-specific preflight requests to succeed.
#   - cors+pna+sw: this endpoint responds with valid CORS and LNA headers and
#     "Access-Control-Allow-Headers: Service-Worker" to preflights. These should
#     be sufficient for both non-LNA preflight requests and LNA-specific
...
#     LNA headers. Preflight requests should fail.
