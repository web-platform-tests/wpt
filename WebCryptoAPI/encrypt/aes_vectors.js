...
function getTestVectors() {
    ...
    var ciphertextGcm192 = new Uint8Array([126, 160, 166, 112, 227, 212, 106,
    ...
    var ciphertextGcm256 = new Uint8Array([8, 97, 235, 113, 70, 32, 135, 131,
    ...
    var tagGcm192_128 = new Uint8Array([183, 57, 32, 144, 164, 76, 121, 77, 58,
        86, 62, 132, 53, 130, 96, 225]);

    var tagGcm256_128 = new Uint8Array([188, 239, 241, 48, 159, 21, 213, 0, 241,
    ...
    var resultGcm192 = new Uint8Array(ciphertextGcm192.byteLength + tagGcm192_128.byteLength);
    resultGcm192.set(ciphertextGcm192, 0);
    resultGcm192.set(tagGcm192_128, ciphertextGcm128.byteLength);

    var resultGcm256 = new Uint8Array(ciphertextGcm256.byteLength + tagGcm256_128.byteLength);
    resultGcm256.set(ciphertextGcm256, 0);
    resultGcm256.set(tagGcm256_128, ciphertextGcm128.byteLength);
    ...
    var vectors = [
        ...
        {
            name: "AES-GCM 192-bit key",
            keyBuffer: keyBytes192,
            key: null,
            algorithm: {name: "AES-GCM", iv: iv256, additionalData: additionalData, tagLength: 128},
            plaintext: plaintext,
            result: resultGcm192
        ...
        {
            name: "AES-GCM 256-bit key",
            keyBuffer: keyBytes256,
            key: null,
            algorithm: {name: "AES-GCM", iv: iv256, additionalData: additionalData, tagLength: 128},
            plaintext: plaintext,
            result: resultGcm256
