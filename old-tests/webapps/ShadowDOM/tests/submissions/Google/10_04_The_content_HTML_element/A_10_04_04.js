...
var A_10_04_04 = {
    ...
    highlight: '[[reset-style-inheritance, a boolean attribute]]' +
    	'[\\s\\S]*[[indicates the state of the reset-style-inheritance flag for this insertion point. ' +
    	'If present, the value of the flag must be set to true]]'
};
...
}), 'A_10_04_04_T01', PROPS(A_10_04_04, {
...
}), 'A_10_04_04_T02', PROPS(A_10_04_04, {
	author:'Sergey G. Grekhov <sgrekhov@unipro.ru>',
	reviewer:''
}));
