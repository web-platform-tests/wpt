...
from third_party.hyper import HTTPConnection, HTTP20Connection
from third_party.hyper import __version__
from third_party.hyper.compat import is_py2, urlencode, urlsplit, write_to_stdout
from third_party.hyper.common.util import to_host_port_tuple
