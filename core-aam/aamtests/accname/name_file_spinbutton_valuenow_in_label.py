TEST_HTML = "<label for='test'>silly <div role='spinbutton' aria-valuemin='1' aria-valuemax='7' aria-valuenow='4'></div><input type='file' id='test'/>"
NAME = "silly 4: No file chosen"
