        ...
        for (let actionSequence of actions) {
            if (actionSequence.type == "pointer") {
                for (let action of actionSequence.actions) {
                    if (action.type == "pointerMove" && !(action.origin instanceof String)) {
                        ...
                        if (frame != null) {
                            ...
                            console.log("action_sequence type " + action.type + " action.origin " +  JSON.stringify(action.origin) + " action.frame " +  JSON.stringify(action.frame));
                        } 
                    }
                }
            }
