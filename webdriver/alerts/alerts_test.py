...
class AlertsTest(base_test.WebDriverBaseTest):
    ...
    def test_should_allow_user_to_accept_a_prompt(self):
        ...
        alert = self.wait.until(lambda x: x.switch_to_alert())
        alert.accept()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == '')

    def test_should_allow_user_to_dismiss_a_prompt(self):
        self.driver.find_element_by_id('prompt').click()
        alert = self.wait.until(lambda x: x.switch_to_alert())
        alert.dismiss()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == 'null')
    ...
    def test_should_allow_user_to_set_the_value_of_a_prompt(self):
        ...
        alert.send_keys('cheese')
        alert.accept()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == 'cheese')
    ...
    def test_prompt_should_use_default_value_if_no_keys_sent(self):
        ...
        alert = self.wait.until(lambda x: x.switch_to_alert())
        alert.accept()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == 'This is a default value')
    ...
    def test_should_allow_user_to_accept_a_confirm(self):
        ...
        alert = self.wait.until(lambda x: x.switch_to_alert())
        alert.accept()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == 'true')

    def test_should_allow_user_to_dismiss_a_confirm(self):
        self.driver.find_element_by_id('confirm').click()
        alert = self.wait.until(lambda x: x.switch_to_alert())
        alert.dismiss()
        self.wait.until(lambda x: self.driver.find_element_by_id('text').text == 'false')
