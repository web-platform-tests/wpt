...
if sys.version_info[0] >= 3:
    ...
    from third_party.py._code._py2traceback import format_exception_only
...
class Code(object):
    ...
    def fullsource(self):
        ...
        """
        from third_party.py._code import source
...
class TracebackEntry(object):
    ...
    def getsource(self, astcache=None):
        ...
        from third_party.py._code.source import getstatementrange_ast
        source = self.frame.code.fullsource
        if source is None:
            return None
        key = astnode = None
...
def patch_builtins(assertion=True, compile=True):
    ...
    if assertion:
        from third_party.py._code import assertion
