...
function getWebGLActiveInfo() {
    ...
    if (!context['getActiveUniform'])
        throw InstantiationError('WebGLContext.getActiveUniform is not defined');
    ...
    return context.getActiveUniform(program, 0);
}
