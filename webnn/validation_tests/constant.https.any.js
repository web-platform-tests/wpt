...
const testsFillSequence = [
  ...
  {
    name: '[constant] Test building sequence with int8 data type and negative step value',
  ...
  },
  {
    ...
    desc: { dataType: 'int8', dimensions: [200] },
    start: -128,
    step: 1,
    output: { dataType: 'int8', dimensions: [200] }
  },
  {
  ...
  {
    name: '[constant] Test building sequence with elements of dimensions are not within the range of int8',
    desc: { dataType: 'int8', dimensions: [200] },
    start: 0,
    step: 0,
    output: { dataType: 'int8', dimensions: [200] }
  ...
  {
    name: '[constant] Test building sequence with value of some items will overflow the max int8',
    desc: { dataType: 'int8', dimensions: [5] },
    start: 126,
    step: 2,
    output: { dataType: 'int8', dimensions: [5] }
  },
  {
    name: '[constant] Test building sequence with value of some items will overflow the max float16',
    desc: { dataType: 'float16', dimensions: [100] },
    start: 65500,
    step: 2.8,
    output: { dataType: 'float16', dimensions: [100] }
  },
  {
    name: '[constant] Test building float16 sequence with start = -infinity, step = 0}',
  ...
  {
    name: '[constant] Test building float32 sequence with start = 0, step = infinity}',
    desc: { dataType: 'float32', dimensions: [5] },
    start: 0,
    step: Infinity,
    output: { dataType: 'float32', dimensions: [5] }
  ...
  {
    name: '[constant] Throw if the start = infinity and the specified data type is not floating point}',
    desc: { dataType: 'int32', dimensions: [5] },
    start: Infinity,
    step: 0
  },
  {
