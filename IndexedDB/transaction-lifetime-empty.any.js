...
indexeddb_test(
    ...
    (t, db) => {
        let saw = expect(t, ['rq1.onsuccess', 'rq2.onsuccess', 'tx1.oncomplete', 'tx2.oncomplete']);

        let tx1 = db.transaction('store', 'readwrite', { durability: 'relaxed' });
        ...
        rq1.onsuccess = t.step_func(() => {
            ...
            let tx2 = db.transaction('store', 'readonly', { durability: 'relaxed' });
...
indexeddb_test(
    ...
    (t, db) => {
        let saw = expect(t, ['rq1.onsuccess', 'rq2.onsuccess', 'tx1.oncomplete', 'tx2.oncomplete', 'tx3.oncomplete']);
        let tx1 = db.transaction('store', 'readwrite', { durability: 'relaxed' });
        tx1.onabort = t.unreached_func('transaction should commit');
        tx1.oncomplete = t.step_func(() => saw('tx1.oncomplete'));
        ...
        rq1.onsuccess = t.step_func(() => {
            ...
            let tx3 = db.transaction('store', 'readonly', { durability: 'relaxed' });
